          ...
          <div class="row">
              <div class="col-xl-12">
                  <div class="breadcrumb-holder">
                      <h1 class="main-title float-left">Requests</h1>
          ...
          <div class="row">
              <div class="col-xl-12">
                <table id="example" class="display dataTable" style="width:100%">
                    ...
                    <input type="text" style="opacity: 0;" name = "copy_text" id = "copy_text" readonly />
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="make_request()">Make request</button>
      </div>
    </div>
  </div>
</div>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable( {
        "ajax": "<?php echo site_url("requests/listing_data");?>",
        "columns": [
            {
