...
<head>
  ...
  <title>Aljasmi Real Estate | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url("admin-assets/default/plugins/iCheck/square/blue.css");?>">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Aljasmi Real Estate </b>v1.0</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <div class="with-errors text-danger"><?php echo $data['submission_error'];?></div><br />


		<form data-toggle="validator" role="form" method="post" action="<?php echo site_url("admin/login");?>">
...
<!-- iCheck -->
<script src="<?php echo base_url("admin-assets/default/plugins/iCheck/icheck.min.js");?>"></script>
<script>
  $(function () {
    $('input').iCheck({
