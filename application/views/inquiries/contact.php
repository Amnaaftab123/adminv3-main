<div class="d-flex p-3 br-5 justify-content-end">
      <div class="pd-0 flex-fill ">
        <div class="input-group">
          <input class="form-control" placeholder="Search for..." type="text" id = 'contact-search-box'>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-xl-3 col-xs-3 col-sm-12">
        <div class = "table-responsive">  
            <table class = "table mg-b-0 text-md-nowrap"  id = "load_contact_inquiries">
            <tbody>
            </tbody>
            </table>
        </div>
