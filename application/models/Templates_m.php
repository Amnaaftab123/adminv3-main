...
class Templates_m extends MY_Model {
  ...
  public function get_templates(){
    ...
    $result = $this->db->query("SELECT * FROM tbl_cust_notification_templates ORDER BY template_name");
    return $result->result_array();

  }

  public function get_template_by_id($id){
      $result = $this->db->query("SELECT t.* FROM tbl_cust_notification_templates t 
